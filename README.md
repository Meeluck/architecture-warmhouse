...
**Управление устройствами** (Device Management) — регистрация/привязка устройства к дому, статус, доступность.

**Управление отоплением** (Heating Control) — команды вкл/выкл, состояние отопления, результат выполнения.

**Мониторинг температуры** (Temperature Monitoring) — получение измерений, хранение, выдача пользователю.
